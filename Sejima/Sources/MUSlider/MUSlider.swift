...
open class MUSlider: MUNibView {
    ...
    open var currentValue: String {
        ...
        set {
            guard let idx = values.firstIndex(of: newValue) else { return }
...
extension MUSlider: UICollectionViewDataSource {
...
extension MUSlider: UICollectionViewDelegate {
