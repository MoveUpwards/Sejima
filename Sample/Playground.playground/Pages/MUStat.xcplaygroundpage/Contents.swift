...
textStat.value = MUStatData.value(for: 4.2, format: "%.1f")
textStat.unit = "km/h"
...
separatorStat.value = MUStatData.value(for: 4.2, format: "%.1f")
...
iconStat.value = MUStatData.value(for: 4.2, format: "%.1f")
iconStat.unit = "km/h"
...
fullStat.value = MUStatData.value(for: 4.2, format: "%.1f")
fullStat.unit = "km/h"
...
multilineStat.value = MUStatData.value(for: 4.2, format: "%.1f")
